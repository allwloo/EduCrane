...
{ // 0 0 0 -> -180 0 90
    ...
    { 
        ...
        */
        ...
        {
            if(trigger)
                transform.Rotate(Vector3.down, 0.46f, Space.Selffalse;);
            if(89 < a && a < 90)false;
                trigger = false;false;
        }
    ...
    void get_trigger()
    {   
        if(transform.rotation.eulerAngles.y> 224 && transform.rotation.eulerAngles.y < 226)
            trigger = false;
    }
